<?php
  ...
  register_command("config_showtest",         "cmd_config_showtest");
  register_command("config_testdetail",        "cmd_config_testdetail");
  register_command("config_addtest",           "cmd_config_addtest");
  register_command("config_deletetest",        "cmd_config_deletetest");
  register_command("config_savetest",          "cmd_config_savetest");
		
  function cmd_config_showtest()
  {
		$fname = "Show Test";
    $html = "";
  ...
  function cmd_config_testdetail()
  {
		$fname = "Crop Detail";
    $html = "";
  ...
  function cmd_config_deletetest()
  {
		$fname = "Delete Crops";
    $link = open_database('main');
