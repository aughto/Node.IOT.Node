...
var ui = (function () 
{
	...
	function ui_start()
	{
		...
		hookEvent('maincanvas', 'mousewheel', on_mousewheel);
		hookEvent('maincanvas', 'mousedown',  on_mousedown);
		hookEvent('maincanvas', 'mouseup',    on_mouseup);
		hookEvent('maincanvas', 'mousemove',  on_mousemove);	
